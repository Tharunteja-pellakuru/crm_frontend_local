...
export const countryToStates = {
  ...
  "Russia": [
    "Moscow", "Saint Petersburg", "Adygea", "Altai", "Bashkortostan", "Buryatia", 
    "Chechnya", "Chuvashia", "Dagestan", "Ingushetia", "Kabardino-Balkaria", 
    "Kalmykia", "Karachay-Cherkessia", "Karelia", "Khakassia", "Komi", "Mari El", 
    "Mordovia", "North Ossetia-Alania", "Sakha", "Tatarstan", "Tuva", "Udmurtia"
  ],
  "Italy": [
  ...
  "Sri Lanka": [
    ...
    "Uva Province", "Western Province", "North Central Province", "North Western Province", "Sabaragamuwa Province"
  ],
  "Nepal": [
    "Province No. 1", "Province No. 2", "Bagmati Province", "Gandaki Province", 
  ...
  "Thailand": [
    ...
    "Chanthaburi", "Chachoengsao", "Chonburi", "Chai Nat", "Chaiyaphum", "Chumphon", 
    ...
    "Nonthaburi", "Narathiwat", "Nan", "Bueng Kan", "Buriram", "Pathum Thani", 
    "Prachuap Khiri Khan", "Prachinburi", "Pattani", "Phra Nakhon Si Ayutthaya", 
    "Phayao", "Phang Nga", "Phatthalung", "Phichit", "Phitsanulok", "Phetchaburi", 
    "Phetchabun", "Phrae", "Phuket", "Maha Sarakham", "Mukdahan", "Mae Hong Son", 
    "Yasothon", "Yala", "Roi Et", "Ranong", "Rayong", "Ratchaburi", "Lopburi", 
    "Lampang", "Lamphun", "Loei", "Sisaket", "Sakon Nakhon", "Songkhla", "Samut Sakhon", 
    "Samut Prakan", "Samut Songkhram", "Sa Kaeo", "Saraburi", "Sing Buri", "Sukhothai", 
    "Suphan Buri", "Surat Thani", "Surin", "Nong Khai", "Nong Bua Lamphu", "Ang Thong", 
    "Amnat Charoen", "Udon Thani", "Uttaradit", "Ubon Ratchathani"
  ],
  "Indonesia": [
  ...
  "Egypt": [
    ...
    "Dakahlia", "Ismailia", "Asyut", "Faiyum", "Sharqia", "Aswan", "Beheira", 
    "Minya", "Damietta", "Luxor", "Qena", "Beni Suef", "Sohag", "Monufia", 
    "Red Sea", "Kafr el-Sheikh", "North Sinai", "Matrouh", "New Valley", "South Sinai"
  ],
  "Nigeria": [
  ...
  "Israel": [
    ...
    "Southern District", "Tel Aviv District", "Judea and Samaria"
  ],
  "Ukraine": [
  ...
  "Poland": [
    ...
    "Lublin", "Lubusz", "Masovia", "Opole", "Podlaskie", "Pomerania", "Silesia", 
    "Subcarpathia", "Świętokrzyskie", "Warmia-Masuria", "West Pomerania"
  ],
  "Sweden": [
  ...
  "Denmark": [
    "Capital Region", "Central Denmark Region", "North Denmark Region", "Region Zealand", "Southern Denmark Region"
  ],
  "Finland": [
    "Åland Islands", "Central Finland", "Central Ostrobothnia", "Kainuu", "Kymenlaakso", 
    "Lapland", "North Karelia", "North Ostrobothnia", "North Savo", "Ostrobothnia", 
    "Päijät-Häme", "Pirkanmaa", "Satakunta", "South Karelia", "South Ostrobothnia", 
  ...
  "Romania": [
    ...
    "Brașov", "Brăila", "Bucharest", "Buzău", "Călărași", "Caraș-Severin", "Cluj", 
  ...
  "Serbia": [
    "Belgrade", "Bor", "Braničevo", "Jablanica", "Kolubara", "Mačva", "Moravica", 
    "Nišava", "Pčinja", "Pirot", "Podunavlje", "Pomoravlje", "Rasina", "Raška", 
    "Šumadija", "Toplica", "Zaječar", "Zlatibor", "South Bačka", "South Banat", 
    "Srem", "North Bačka", "North Banat", "Central Banat", "West Bačka"
  ],
  "Croatia": [
    ...
    "Split-Dalmatia", "Varaždin", "Virovitica-Podravina", "Vukovar-Srijem", 
  ...
  "Slovenia": [
    "Ajdovščina", "Bled", "Bovec", "Brežice", "Celje", "Cerknica", "Domžale", 
    "Dravograd", "Gornja Radgona", "Grosuplje", "Hrastnik", "Idrija", "Ilirska Bistrica", 
    "Izola", "Jesenice", "Kamnik", "Koper", "Kostanjevica na Krki", "Kočevje", 
    "Kranj", "Krško", "Laško", "Lenart", "Lendava", "Litija", "Ljubljana", "Ljutomer", 
    "Logatec", "Maribor", "Medvode", "Mengeš", "Metlika", "Mežica", "Murska Sobota", 
    "Nova Gorica", "Novo Mesto", "Ormož", "Piran", "Postojna", "Prebold", "Ptuj", 
    "Radeče", "Radovljica", "Ravne na Koroškem", "Ribnica", "Rogaška Slatina", 
    "Ruše", "Sevnica", "Sežana", "Slovenj Gradec", "Slovenska Bistrica", "Slovenske Konjice", 
    "Šempeter-Vrtojba", "Šentjur", "Škofja Loka", "Šmarje pri Jelšah", "Tolmin", 
    "Trbovlje", "Trebnje", "Tržič", "Velenje", "Vipava", "Vitanje", "Vodice", 
    "Vrhnika", "Vuzenica", "Zagorje ob Savi", "Zalec", "Žalec", "Železniki", "Žiri"
  ],
  ...
  "North Macedonia": [
    "Aerodrom", "Aračinovo", "Berovo", "Bitola", "Bogdanci", "Bogovinje", "Bosilovo", 
    "Brvenica", "Butel", "Čair", "Čaška", "Centar", "Centar Župa", "Češinovo-Obleševo", 
    "Čučer-Sandevo", "Debar", "Debarca", "Delčevo", "Demir Hisar", "Demir Kapija", 
    "Dojran", "Dolneni", "Drugovo", "Gazi Baba", "Gevgelija", "Gjorče Petrov", 
    "Gostivar", "Gradsko", "Ilinden", "Jegunovce", "Karbinci", "Karpoš", "Kavadarci", 
    "Kičevo", "Kisela Voda", "Kočani", "Konče", "Kratovo", "Kriva Palanka", "Krivogaštani", 
    "Kruševo", "Kumanovo", "Lipkovo", "Lozovo", "Makedonska Kamenica", "Makedonski Brod", 
    "Mavrovo and Rostuša", "Mogila", "Negotino", "Novaci", "Novo Selo", "Ohrid", 
    "Pehčevo", "Petrovec", "Plasnica", "Prilep", "Probištip", "Radoviš", "Rankovce", 
    "Resen", "Rosoman", "Saraj", "Sopište", "Staro Nagoričane", "Štip", "Struga", 
    "Strumica", "Studeničani", "Šuto Orizari", "Sveti Nikole", "Tearce", "Tetovo", 
    "Valandovo", "Vasilevo", "Veles", "Vevčani", "Vinica", "Vrapčište", "Zajas", 
    "Zelenikovo", "Želino", "Zrnovci"
  ],
  "Montenegro": [
    "Andrijevica", "Bar", "Berane", "Bijelo Polje", "Budva", "Cetinje", "Danilovgrad", 
    "Gusinje", "Herceg Novi", "Kolašin", "Kotor", "Mojkovac", "Nikšić", "Petnjica", 
    "Plav", "Pljevlja", "Plužine", "Podgorica", "Rožaje", "Šavnik", "Tivat", 
    "Tuzi", "Ulcinj", "Žabljak"
  ],
  "Kazakhstan": [
    "Akmola", "Aktobe", "Almaty", "Almaty Region", "Atyrau", "Baikonur", "East Kazakhstan", 
  ...
  "Uzbekistan": [
    ...
    "Khorezm", "Namangan", "Navoiy", "Samarkand", "Sirdaryo", "Surkhandarya", "Tashkent", "Tashkent Region"
  ],
  "Azerbaijan": [
    "Absheron", "Agdam", "Agdash", "Aghjabadi", "Agstafa", "Agsu", "Astara", 
    "Baku", "Balakan", "Barda", "Beylagan", "Bilasuvar", "Dashkasan", "Fizuli", 
    "Gadabay", "Ganja", "Gobustan", "Goranboy", "Goychay", "Goygol", "Hajigabul", 
    "Imishli", "Ismailli", "Jabrayil", "Jalilabad", "Julfa", "Kalbajar", "Kangarli", 
    "Khachmaz", "Khankendi", "Khatayi", "Khizi", "Khojaly", "Khojavend", "Kurdamir", 
    "Lachin", "Lankaran", "Lerik", "Masally", "Mingachevir", "Nakhchivan", "Neftchala", 
    "Oghuz", "Ordubad", "Qabala", "Qakh", "Qazakh", "Quba", "Qubadli", "Qusar", 
    "Saatly", "Sabirabad", "Shabran", "Shahbuz", "Shaki", "Shamakhi", "Shamkir", 
    "Sharur", "Shirvan", "Shusha", "Siyazan", "Sumqayit", "Tartar", "Tovuz", 
    "Ujar", "Yardymli", "Yevlakh", "Zagatala", "Zangilan", "Zaqatala", "Zardab"
  ],
  "Belarus": [
  ...
  "Moldova": [
    ...
    "Căușeni", "Chișinău", "Cimișlia", "Criuleni", "Dondușeni", "Drochia", 
    "Dubăsari", "Edineț", "Fălești", "Florești", "Glodeni", "Hîncești", 
    "Ialoveni", "Leova", "Nisporeni", "Ocnița", "Orhei", "Rezina", "Rîșcani", 
    "Sîngerei", "Soroca", "Strășeni", "Șoldănești", "Ștefan Vodă", "Taraclia", 
    "Telenești", "Ungheni", "Gagauzia", "Bălți", "Bender"
  ],
  "Armenia": [
  ...
  "Kyrgyzstan": [
    "Batken", "Bishkek", "Chuy", "Issyk-Kul", "Jalal-Abad", "Naryn", "Osh", "Osh City", "Talas"
  ],
  "Tajikistan": [
    "Dushanbe", "Sughd", "Khatlon", "Districts of Republican Subordination", "Gorno-Badakhshan"
  ],
  "Turkmenistan": [
  ...
  "Taiwan": [
    ...
    "Kaohsiung", "Keelung", "Kinmen", "Lienchiang", "Miaoli", "Nantou", "New Taipei", 
    "Penghu", "Pingtung", "Taichung", "Tainan", "Taipei", "Taitung", "Taoyuan", "Yilan", "Yunlin"
  ],
  "Hong Kong": ["Hong Kong Island", "Kowloon", "New Territories"],
  "Macau": ["Macau"],
  "Qatar": ["Doha", "Al Khor", "Al Wakrah", "Al Rayyan", "Umm Salal", "Al Daayen", "Al Shamal"],
  ...
  "Jordan": [
    "Amman", "Ajloun", "Aqaba", "Balqa", "Irbid", "Jerash", "Karak", "Ma'an", "Madaba", "Mafraq", "Tafilah", "Zarqa"
  ],
  "Lebanon": [
    "Akkar", "Baalbek-Hermel", "Beirut", "Beqaa", "Keserwan-Jbeil", "Mount Lebanon", 
    "Nabatieh", "North", "South"
  ],
  "Iraq": [
    "Al Anbar", "Al Muthanna", "Al Qadisiyyah", "Babil", "Baghdad", "Basra", "Dhi Qar", 
    "Diyala", "Dohuk", "Erbil", "Halabja", "Karbala", "Kirkuk", "Maysan", "Mosul", 
  ...
  "Afghanistan": [
    ...
    "Kapisa", "Khost", "Kunar", "Kunduz", "Laghman", "Logar", "Nangarhar", "Nimruz", 
  ...
  "Cambodia": [
    ...
    "Prey Veng", "Pursat", "Ratanakiri", "Siem Reap", "Stung Treng", "Svay Rieng", "Takeo", "Tboung Khmum"
  ],
  "Laos": [
    "Attapeu", "Bokeo", "Bolikhamsai", "Champasak", "Houaphanh", "Khammouane", 
    "Luang Namtha", "Luang Prabang", "Oudomxay", "Phongsaly", "Sainyabuli", "Salavan", 
    "Savannakhet", "Sekong", "Vientiane", "Vientiane Prefecture", "Xaisomboun", "Xiangkhouang"
  ],
  ...
  "Fiji": [
    ...
    "Naitasiri", "Namosi", "Ra", "Rewa", "Rotuma", "Serua", "Tailevu", "Tikina"
  ],
  "Papua New Guinea": [
    ...
    "New Ireland", "Oro", "Sandaun", "Southern Highlands", "West New Britain", 
    "West Sepik", "Western", "Western Highlands"
  ],
  "New Caledonia": ["North Province", "South Province", "Loyalty Islands"],
  "Vanuatu": [
  ...
  "Marshall Islands": ["Ailinglaplap", "Ailuk", "Arno", "Aur", "Bikini", "Ebon", "Enewetak", "Jabat", "Jaluit", "Kili", "Kwajalein", "Lae", "Lib", "Likiep", "Majuro", "Maloelap", "Mejit", "Mili", "Namorik", "Namu", "Rongelap", "Ujae", "Utirik", "Wotho", "Wotje"],
  ...
  "Chad": ["Bahr el Gazel", "Batha", "Borkou", "Chari-Baguirmi", "Ennedi-Est", "Ennedi-Ouest", "Guéra", "Hadjer-Lamis", "Kanem", "Lac", "Logone Occidental", "Logone Oriental", "Mandoul", "Mayo-Kebbi Est", "Mayo-Kebbi Ouest", "Moyen-Chari", "Ouaddaï", "Salamat", "Sila", "Tandjilé", "Tibesti", "Wadi Fira", "N'Djamena"],
  "Central African Republic": ["Bamingui-Bangoran", "Bangui", "Basse-Kotto", "Haute-Kotto", "Haut-Mbomou", "Kémo", "Lobaye", "Mbomou", "Nana-Grebizi", "Nana-Mambéré", "Ombella-M'Poko", "Ouaka", "Ouham", "Ouham Péndé", "Sangha-Mbaéré", "Vakaga"],
  ...
  "Tanzania": ["Arusha", "Dar es Salaam", "Dodoma", "Geita", "Iringa", "Kagera", "Katavi", "Kigoma", "Kilimanjaro", "Lindi", "Manyara", "Mara", "Mbeya", "Mjini Magharibi", "Morogoro", "Mtwara", "Mwanza", "Nairobi", "Njombe", "Pemba North", "Pemba South", "Pwani", "Rukwa", "Ruvuma", "Shinyanga", "Simiyu", "Singida", "Songwe", "Tabora", "Tanga", "Zanzibar Central/South", "Zanzibar North", "Zanzibar Urban/West"],
  ...
  "Mauritius": ["Agalega Islands", "Black River", "Flacq", "Grand Port", "Moka", "Pamplemousses", "Plaines Wilhems", "Port Louis", "Rivière du Rempart", "Rodrigues", "Saint Brandon", "Savanne"],
  "Seychelles": ["Anse aux Pins", "Anse Boileau", "Anse Etoile", "Anse Royale", "Au Cap", "Baie Lazare", "Baie Sainte Anne", "Beau Vallon", "Bel Air", "Bel Ombre", "Cascade", "Glacis", "Grand'Anse Mahe", "Grand'Anse Praslin", "La Digue", "La Riviere Anglaise", "Mont Buxton", "Mont Fleuri", "Plaisance", "Pointe La Rue", "Port Glaud", "Roche Caiman", "Saint Louis", "Takamaka"],
  ...
  "Guinea-Bissau": ["Bafatá", "Biombo", "Bissau", "Bolama-Bijagós", "Cacheu", "Gabú", "Oio", "Quinara", "Tombali"],
  ...
  "Libya": ["Al Butnan", "Al Jabal al Akhdar", "Al Jabal al Gharbi", "Al Jifarah", "Al Kufrah", "Al Marj", "Al Marqab", "Al Wahat", "An Nuqat al Khams", "Az Zawiyah", "Banghazi", "Darnah", "Ghat", "Misratah", "Murzuq", "Nalut", "Sabha", "Surt", "Tarabulus", "Wadi al Hayat", "Wadi ash Shati'"],
  ...
  "Morocco": ["Agadir-Ida Ou Tanane", "Al Haouz", "Al Hoceïma", "Aousserd", "Assa-Zag", "Azilal", "Beni Mellal", "Benslimane", "Berkane", "Berrechid", "Boujdour", "Boulmane", "Casablanca", "Chefchaouen", "Chichaoua", "Chtouka-Aït Baha", "Dakhla-Oued Ed-Dahab", "Drâa-Tafilalet", "El Hajeb", "El Jadida", "Errachidia", "Es-Semara", "Essaouira", "Fahs-Anjra", "Fès", "Figuig", "Fquih Ben Salah", "Guelmim", "Guercif", "Ifrane", "Inezgane-Aït Melloul", "Jerada", "Kénitra", "Khémisset", "Khénifra", "Khouribga", "Laâyoune", "Larache", "Marrakech", "Médiouna", "Meknès", "Midelt", "Mohammadia", "Moulay Yacoub", "Nador", "Nouaceur", "Ouarzazate", "Oued Ed-Dahab", "Oujda-Angad", "Rabat", "Rehamna", "Safi", "Salé", "Sefrou", "Settat", "Sidi Bennour", "Sidi Ifni", "Sidi Kacem", "Sidi Slimane", "Skhirate-Témara", "Tanger-Assilah", "Tan-Tan", "Taounate", "Taourirt", "Tarfaya", "Taroudant", "Tata", "Taza", "Tétouan", "Tinghir", "Tiznit", "Youssoufia", "Zagora"],
  "Western Sahara": ["Aousserd", "Boujdour", "Dakhla", "Es-Semara", "Laâyoune", "Oued Ed-Dahab"],
  "Cape Verde": ["Barlavento", "Sotavento", "Boa Vista", "Brava", "Maio", "Mosteiros", "Paul", "Porto Novo", "Praia", "Ribeira Brava", "Ribeira Grande", "Sal", "Santa Catarina", "Santa Cruz", "São Domingos", "São Filipe", "São Lourenço dos Órgãos", "São Miguel", "São Nicolau", "São Salvador do Mundo", "São Vicente", "Tarrafal", "Tarrafal de São Nicolau"],
  "São Tomé and Príncipe": ["Água Grande", "Cantagalo", "Caué", "Lembá", "Lobata", "Mé-Zóchi", "Autonomous Region of Príncipe"],
  "Equatorial Guinea": ["Annobón", "Bioko Norte", "Bioko Sur", "Centro Sur", "Kié-Ntem", "Litoral", "Wele-Nzas"],
  "Gabon": ["Estuaire", "Haut-Ogooué", "Moyen-Ogooué", "Ngounié", "Nyanga", "Ogooué-Ivindo", "Ogooué-Lolo", "Ogooué-Maritime", "Woleu-Ntem"],
  "Republic of the Congo": ["Bouenza", "Brazzaville", "Cuvette", "Cuvette-Ouest", "Kouilou", "Lékoumou", "Likouala", "Niari", "Plateaux", "Pointe-Noire", "Pool", "Sangha"],
  "Democratic Republic of the Congo": ["Bas-Uele", "Équateur", "Haut-Katanga", "Haut-Lomami", "Haut-Uele", "Ituri", "Kasaï", "Kasaï-Central", "Kasaï-Oriental", "Kinshasa", "Kongo Central", "Kwango", "Kwilu", "Lomami", "Lualaba", "Mai-Ndombe", "Maniema", "Mongala", "Nord-Kivu", "Nord-Ubangi", "Sankuru", "Sud-Kivu", "Sud-Ubangi", "Tanganyika", "Tshopo", "Tshuapa"],
